...
# -----------------------------
st.set_page_config(page_title="smartbot.ai", page_icon="📚", layout="centered")
...
if user_role == "teacher":
    st.markdown("<div class='big-title' style='color:#fc8404;'>👨‍🏫 smartbot.ai / Teacher</div>", unsafe_allow_html=True)
    ...
    if teacher_menu == "Class Management":
        ...
        if st.button("🤖 Generate with SmartBot AI", type="primary", use_container_width=True):
